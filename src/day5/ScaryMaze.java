...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == -16252673) {
			scare();
		}
		// call the scare method

		// 10. if the mouse is on the end color
		if (mouseColor == -13631744) {
			JOptionPane.showMessageDialog(null, "Congratumalations, you win boi.");
		}
	...
	private void scare() {
		...
		sound.play();
		showScaryImage("spookydemons .jpg");
